...
$router->get('/', [ProductController::class, 'getTrangchu']);
$router->get('/ds-san-pham', [ProductController::class, 'getProducts']);
$router->get('/them-sanpham', [ProductController::class, 'getThem']);
$router->get('/chitiet-sanpham', [ProductController::class, 'getChitiet']);
